...
if (!isset($_SESSION['exam_questions']) || empty($_SESSION['exam_questions'])) {
    ...
    $category = $db->fetchOne($categoryQuery, [
        ...
        if ($category) {
            ...
            $randomQuestionsQuery = "SELECT id, question_text, question_order
                                    FROM questions
            ...
            // Now get all options for these questions
            $questionsQuery = "SELECT q.id, q.question_text, q.question_order,
            ...
            $results = $db->fetchAll($questionsQuery, $questionIds);
...
<body>
    ...
    <script>
        ...
        function startExam() {
            ...
            isNavigating = true;
            window.location.href = 'examination.php?step=1';
        }
    ...
    updateSidebar();
        ...
        function navigateQuestion(direction) {
            ...
            if (nextStep !== currentStep) {
                ...
                isNavigating = true;
                window.location.href = 'examination.php?step=' + nextStep;
            }
        }
